...
exports.scopes = [
  ...
  /*Customdata for more than  65 kb*/
  [
    ...
    function (nock) {
      var result = nock('https://management.core.windows.net:443')
        .get('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/operations/e201c9379bfd3a02ad915f1ef3f7c039')
    ...
    function (nock) {
      var result = nock('https://management.core.windows.net:443')
        ...
        .post('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices/xplatcustomvm/deployments', "*")
        .reply(202, '<Deployment xmlns="http://schemas.microsoft.com/windowsazure" xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><Name>xplatcustomvm</Name><DeploymentSlot>Production</DeploymentSlot><Label>eHBsYXR0ZXN0dm1jdXN0b21kYXRh</Label><RoleList><Role><RoleName>xplatcustomvm</RoleName><RoleType>PersistentVMRole</RoleType><ConfigurationSets><ConfigurationSet><ConfigurationSetType>LinuxProvisioningConfiguration</ConfigurationSetType><HostName>xplatcustomvm</HostName><UserName>testuser</UserName><UserPassword>Collabera@01</UserPassword><CustomData>bm9kZWpzLHB5dGhvbg==</CustomData></ConfigurationSet></ConfigurationSets><OSVirtualHardDisk><SourceImageName>xplattestimg</SourceImageName></OSVirtualHardDisk><RoleSize>Small</RoleSize></Role></RoleList></Deployment>', {
          'cache-control' : 'no-cache',
          'content-length' : '775',
