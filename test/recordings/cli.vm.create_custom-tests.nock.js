  ...
  [
    ...
    function (nock) {
      var result = nock('https://management.core.windows.net:443')
        ...
        .post('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices/xplattestvmcustomdata/certificates', "*")
        .reply(202, "", {
          'cache-control' : 'no-cache',
          'content-length' : '0',
          server : '1.0.6198.25 (rd_rdfe_stable.131118-1436) Microsoft-HTTPAPI/2.0',
    ...
    function (nock) {
      var result = nock('https://management.core.windows.net:443')
        .get('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/operations/872c6309016d3f6da2fc87faedfbb793')
    ...
    function (nock) {
      var result = nock('https://management.core.windows.net:443')
        ...
        .post('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices/xplattestvmcustomdata/deployments', "*")
        .reply(202, '<Deployment xmlns="http://schemas.microsoft.com/windowsazure" xmlns:i="http://www.w3.org/2001/XMLSchema-instance"><Name>xplattestvmcustomdata</Name><DeploymentSlot>Production</DeploymentSlot><Label>eHBsYXR0ZXN0dm1jdXN0b21kYXRh</Label><RoleList><Role><RoleName>xplattestvmcustomdata</RoleName><RoleType>PersistentVMRole</RoleType><ConfigurationSets><ConfigurationSet><ConfigurationSetType>LinuxProvisioningConfiguration</ConfigurationSetType><HostName>xplattestvmcustomdata</HostName><UserName>testuser</UserName><UserPassword>Collabera@01</UserPassword><CustomData>bm9kZWpzLHB5dGhvbg==</CustomData></ConfigurationSet></ConfigurationSets><OSVirtualHardDisk><SourceImageName>xplattestimg</SourceImageName></OSVirtualHardDisk><RoleSize>Small</RoleSize></Role></RoleList></Deployment>', {
          'cache-control' : 'no-cache',
          'content-length' : '775',
    ...
    function (nock) {
      var result = nock('https://management.core.windows.net:443')
        .get('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices')
        .reply(200, "<HostedServices xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><HostedService><Url>https://management.core.windows.net/bfb5e0bf-124b-4d0c-9352-7c0a9f4d9948/services/hostedservices/xplattestvmcustomdata</Url><ServiceName>xplattestvmcustomdata</ServiceName><HostedServiceProperties><Description>Implicitly created hosted service</Description><Location>West US</Location><Label>eHBsYXR0ZXN0dm0=</Label><Status>Created</Status><DateCreated>2013-11-22T05:21:47Z</DateCreated><DateLastModified>2013-11-22T05:22:06Z</DateLastModified><ExtendedProperties/></HostedServiceProperties></HostedService></HostedServices>", {
          'cache-control': 'no-cache',
          'content-length': '1120',
          'content-type': 'application/xml; charset=utf-8',
          server: '1.0.6198.25 (rd_rdfe_stable.131118-1436) Microsoft-HTTPAPI/2.0',
    ...
    function (nock) {
      var result = nock('https://management.core.windows.net:443')
        .get('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices/xplattestvmcustomdata/deploymentslots/Production')
