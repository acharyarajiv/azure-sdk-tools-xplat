  ...
  [
    ...
    function (nock) {
      var result = nock('https://management.core.windows.net:443')
        ...
        .post('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices/xplattestvnet-1/deployments', "*")
        .reply(202, "", {
          'cache-control' : 'no-cache',
          'content-length' : '0',
          server : '1.0.6198.25 (rd_rdfe_stable.131118-1436) Microsoft-HTTPAPI/2.0',
    ...
    function (nock) {
      var result = nock('https://management.core.windows.net:443')
        .get('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices/xplattestvnet-1/deploymentslots/Production')
        .reply(404, "<Error xmlns=\"http://schemas.microsoft.com/windowsazure\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><Code>ResourceNotFound</Code><Message>No deployments were found.</Message></Error>", {
          'cache-control' : 'no-cache',
          'content-length' : '2445',
          'content-type' : 'application/xml; charset=utf-8',
  ...
  [
    ...
    function (nock) {
      ...
      var result = nock('https://management.core.windows.net:443')
        ...
        .post('/db1ab6f0-4769-4b27-930e-01e2ef9c123c/services/hostedservices/xplattestvnet/deployments', "*")
        .reply(202, "", {
          'cache-control' : 'no-cache',
          'content-length' : '0',
          server : '1.0.6198.25 (rd_rdfe_stable.131118-1436) Microsoft-HTTPAPI/2.0',
